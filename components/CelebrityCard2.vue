<template>
  <div>
    <NuxtLink
      style="color:#000;" class="card mx-auto" :to="`/celebrity/${celebrity?.slug}`">
      <img
      ...
      <div class="card-body">
        ...
        <p class="card-text" v-if="celebrity?.spots_count">
          ({{ celebrity?.spots_count }} {{ celebrity?.spots_count > 1 ? ' spots' : 'spot' }})
        </p>
      </div>
    </NuxtLink>
  </div>
